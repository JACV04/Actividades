...
class Brain {
    ...
    init = function init() {
        ...
        document.body.style.backgroundColor = "#eceeee";
    }
    ...
    apiStart = function apiStart() {
        ...
        fetch(url)
            ...
            .then(data => {
                ...
                gender.textContent = "Genero: " + person.gender;
                country.textContent = "País: " + person.location.country;
                phone.textContent = "Telefono: " + person.phone;
    ...
    apiImagesRandom = function apiImagesRandom() {
        Util.createTitle("API Imagenes Random:");
        let content = document.createElement('div');
        let maxImages = 50;
    ...
    /* Function: Crea una caja aleatoria con una posición y color aleatorio */
